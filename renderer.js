...
var Renderer = (function () {
    ...
    */
    ...
    function Renderer (canvas, wgl, gridDimensions, onLoaded) {
        ...
        // Default particle color (hue from HSV)
        this.particleColorHue = 0.6; // Default blue
        
        // Color variety factor (0 = single color, 1 = maximum variety)
        this.colorVariety = 0.5; // Default medium variety
        
        // Time for animated color effects
        this.time = 0.0;
    ...
    Renderer.prototype.draw = function (simulator, projectionMatrix, viewMatrix) {
        ...
        // Update time for color animation with faster increment
        this.time += 0.03;
        ...
        var compositeDrawState = wgl.createDrawState()
            ...
            .uniform1f('u_particleColorHue', this.particleColorHue)
            .uniform1f('u_colorVariety', this.colorVariety)
